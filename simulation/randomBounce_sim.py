...
turning = 0
turning_time = 5
obs_Threshold = 0.44 #distance to an obstacle/wall before robot needs to turn away (in metres)
slow_threshold = 0.6 #distance to an obstacle/wall before robot needs to slow down (in metres)
